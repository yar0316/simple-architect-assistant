...
try:
    ...
    from langchain_integration.mcp_tools import get_langchain_mcp_manager, MCPToolFactory, is_langchain_mcp_available
    from langchain_integration.memory_manager import get_memory_manager, is_memory_available, ConversationAnalyzer
    LANGCHAIN_INTEGRATION_AVAILABLE = True
except ImportError as e:
    st.warning(f"LangChain統合モジュールの読み込みに失敗しました: {e}")
